...
public class ProcesadorTextoMenuCheckRadio {

    public static void main(String[] args) {
        MarcoCentrado marco = new MarcoCentrado();
        LaminaProcesadorTextoCheckRadio lamina = new LaminaProcesadorTextoCheckRadio();
        marco.add(lamina);
...
final class LaminaProcesadorTextoCheckRadio extends JPanel {
    ...
    public LaminaProcesadorTextoCheckRadio() {
